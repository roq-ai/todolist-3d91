...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'team-member'], key: 'order', tenantPath: [], userPath: [] },
  'order_status_updated.update': { roles: ['owner', 'team-member'], key: 'order', tenantPath: [], userPath: [] },
  'product_added.create': { roles: ['owner', 'team-member'], key: 'product', tenantPath: [], userPath: [] },
};
