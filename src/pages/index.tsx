  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless task management with todolist, your ultimate solution for organizing and prioritizing your daily tasks and projects."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1586473219010-2ffc57b0d282?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0YXNrJTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTY4NDk5NTB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@villxsmil?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Luis Villasmil`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless task management with todolist, your ultimate solution for organizing and prioritizing your daily tasks and projects.`}
            </Text>
            <Box
